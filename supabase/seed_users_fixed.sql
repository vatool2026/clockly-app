-- Skript: Sicheres Setup für Clockly (Firma & Nutzer)
-- Führe dies im Supabase SQL Editor aus.

-- 1. Alles sauber löschen (CASCADE löscht automatisch Profile etc.)
...
BEGIN
    ...
    VALUES (
        ...
        'vatool2026@gmail.com', crypt('Start123!', gen_salt('bf')), now(), 
    ...
    VALUES (
        ...
        'andre.reitz@cb-akustik.de', crypt('Start123!', gen_salt('bf')), now(), 
        '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb, now(), now(), 
        '', '', '', ''
    );
    ...
    VALUES (
        ...
        'andre.reitz88@googlemail.com', crypt('Start123!', gen_salt('bf')), now(), 
        '{"provider":"email","providers":["email"]}'::jsonb, '{}'::jsonb, now(), now(), 
        '', '', '', ''
    );
